...
const HotelDetails = () => {
  ...
  const hotel = {
    ...
    description: 'Experience timeless elegance at The Ritz Paris, a legendary hotel in the heart of the City of Light.',
      ...
      <div className="relative h-[400px] bg-gray-200">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
          <div className="container">
            <Link to="/hotels" className="inline-flex items-center gap-2 text-white/80 hover:text-white mb-4">
