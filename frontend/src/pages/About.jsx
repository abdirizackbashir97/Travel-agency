...
const About = () => {
  ...
  const teamMembers = [
    { name: 'John Mwangi', role: 'CEO & Founder', image: '👨‍💼', bg: 'bg-blue-100' },
    { name: 'Sarah Wanjiku', role: 'Travel Consultant', image: '👩‍💼', bg: 'bg-pink-100' },
    { name: 'Brian Otieno', role: 'Operations Manager', image: '👨‍💻', bg: 'bg-green-100' },
    { name: 'Aisha Ahmed', role: 'Customer Support', image: '👩‍💻', bg: 'bg-purple-100' }
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="relative bg-gradient-to-r from-blue-600 via-blue-700 to-blue-800 text-white py-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-lg text-blue-200 max-w-2xl mx-auto mt-2">At SkyRoute Travel Agency, we turn your travel dreams into unforgettable experiences.</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-600 leading-relaxed">SkyRoute Travel Agency was founded with a simple goal – to make travel easier, more affordable, and more memorable for everyone. From flight bookings to dream vacations, we are dedicated to helping people explore the world with confidence and ease.</p>
            <div className="mt-6 grid grid-cols-2 gap-4">
              <div className="bg-blue-50 p-4 rounded-xl"><h4 className="font-bold text-blue-600">Our Mission</h4><p className="text-sm text-gray-600">To provide reliable, affordable, and personalized travel services.</p></div>
              <div className="bg-purple-50 p-4 rounded-xl"><h4 className="font-bold text-purple-600">Our Vision</h4><p className="text-sm text-gray-600">To become one of the most trusted travel agencies worldwide.</p></div>
            </div>
          </div>
          <div className="bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl p-8 text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-blue-100">We believe every journey should be seamless, enjoyable, and memorable. With SkyRoute, you're not just booking a trip – you're creating a story.</p>
              <button onClick={() => navigate('/destinations')} className="mt-4 px-6 py-2 bg-white text-blue-600 font-semibold rounded-full hover:shadow-lg transition inline-flex items-center gap-2">Explore Destinations <ChevronRight className="w-4 h-4" /></button>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {services.map((service, index) => {
              ...
              const colorMap = {
                ...
                teal: 'bg-teal-100 text-teal-600', rose: 'bg-rose-100 text-rose-600',
              };
              return (
              ...
              return (
                <div key={index} className="bg-white p-5 rounded-xl shadow-sm hover:shadow-md transition group">
                  <div className="flex items-center gap-3 mb-2">
                    <div className="p-2 bg-blue-50 rounded-lg group-hover:bg-blue-100 transition"><Icon className="w-5 h-5 text-blue-600" /></div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 text-center">
            {stats.map((stat, index) => {
              ...
              return (
                <div key={index}>
                  <div className="flex justify-center mb-2"><Icon className="w-8 h-8 text-blue-200" /></div>
      ...
      <div className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 max-w-2xl mx-auto">Our passionate team of travel experts works tirelessly to ensure every journey is smooth and memorable.</p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {teamMembers.map((member, index) => (
              <div key={index} className="text-center group">
                <div className={`w-24 h-24 mx-auto ${member.bg} rounded-2xl flex items-center justify-center text-5xl group-hover:scale-110 transition duration-300 mb-3`}>{member.image}</div>
      ...
      <div className="relative bg-gradient-to-r from-blue-600 to-purple-600 text-white py-16 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-lg text-blue-100 mb-8">Discover amazing destinations, book your flights and hotels with ease, and let SkyRoute make your dream vacation a reality.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button onClick={() => navigate('/destinations')} className="px-8 py-3 bg-white text-blue-600 font-semibold rounded-full hover:shadow-lg hover:scale-105 transition-all duration-300 inline-flex items-center justify-center gap-2">Explore Destinations <ChevronRight className="w-4 h-4" /></button>
            <button onClick={() => navigate('/booking')} className="px-8 py-3 border-2 border-white text-white font-semibold rounded-full hover:bg-white/10 transition inline-flex items-center justify-center gap-2">Book Now</button>
          </div>
        </div>
      </div>
    </div>
